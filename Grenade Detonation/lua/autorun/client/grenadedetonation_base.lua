hook.Add( "PopulateToolMenu", "GrenadeDetonationSettings", function()
	...
	panel:Help( "Can bullets induce detonation?" )
	panel:CheckBox( "Explosive damage can detonate", "DetonationDetExploDamage" )
	panel:Help( "Can explosive damage induce detonation?" )
	panel:CheckBox( "Any damage can detonate", "DetonationDetAnyDamage" )
	...
	panel:Help( "Allow all damage types to arm the grenade." )
