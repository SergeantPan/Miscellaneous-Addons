hook.Add( "PopulateToolMenu", "GrenadeDetonationSettingsNPCs", function()
	...
	panel:Help("Chance for a damaged Combine Soldier to drop a grenade.")
	...
	panel:Help( "Combine Soldiers who have already dropped a grenade cannot drop another" )
	...
	panel:Help( "Combine Soldiers will no longer be able to throw grenades after dropping one. Requires the Prevent Grenade Dupes setting to be enabled." )

	panel:CheckBox( "Enable physical grenades system for NPCs", "GrenadeCarryPhysical" )
	panel:Help( "Combine Soldiers will carry physical grenades on their model, which can be shot to trigger arming or detonation." )
	...
	panel:Help( "Combine Soldiers with grenades will drop one on death." )
	panel:NumSlider( "Grenade Drop Chance", "GrenadeCarryDropChance", 0, 100, 0 )
	panel:Help("Chance for a killed Combine Soldier to drop a grenade.")
	panel:CheckBox( "NPCs must have a grenade to drop", "GrenadeCarryDropRequireNade" )
	panel:Help( "Combine Soldiers will not drop a grenade on death if they have already dropped one. Requires the Prevent Grenade Dupes setting to be enabled." )
