hook.Add( "PopulateToolMenu", "GrenadeDetonationSettingsHitbox", function()
	...
	local HitboxChoice = panel:ComboBox("Grenade Hitbox Type", "DetonationHitboxType")
	...
	local HitboxChoice = panel:ComboBox("SMG Grenade Hitbox Type", "SMGDetonationHitboxType")
	HitboxChoice:SetSortItems(false)
	HitboxChoice:AddChoice("Spherical", "1")
	HitboxChoice:AddChoice("Cubical", "2")
	HitboxChoice:AddChoice("Grenade", "3")
	HitboxChoice:AddChoice("Custom", "4")
	panel:Help( "Select the style of hitbox for the SMG grenades. Affects the size and shape of the hitbox, has no effect on the grenade itself." )

	panel:AddControl("TextBox", {
	Label = "Custom model",
	Command = "SMGDetonationHitboxModel", })
	panel:Help( "Use a custom model for the hitbox. Use the 'Custom' option for this to function.")


	panel:Button("Create grenade test object", "DetonationTestObject")
	panel:Button("Create SMG grenade test object", "DetonationTestObject2")
	...
	panel:Help( "Delete the test object(s)." )
end)
end)